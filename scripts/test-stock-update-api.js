// Test script to verify stock update functionality via API
...
async function testStockUpdate() {
  try {
    console.log('🧪 Testing stock update functionality via API...\n');
    ...
    console.log('\n📋 Step 3: How to check if stock updates are working:');
